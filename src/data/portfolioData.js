export const portfolioData = {
    ...
    skills: [
        ...
        { title: "Front End", items: ["HTML", "CSS", "JavaScript"] },
        { title: "Tools", items: ["Git", "GitHub", "VS Code"] },
        { title: "Design", items: ["Responsive Web Design", "Figma", "Wix"] },
        { title: "Backend", items: ["Django", "Pandas"] },
        { title: "Currently Learning", items: ["DSA", "C Programming", "C#"] }
    ],
    certificates: [
